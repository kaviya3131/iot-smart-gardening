                ...
                children: <Widget>[
                  ...
                  ButtonTheme.bar( // make buttons use the appropriate styles for cards
                    child: ButtonBar(
                      children: <Widget>[
                        FlatButton(
                          child: const Text('Temperature : 24°C',style: TextStyle(color: Colors.green),),
                          onPressed: () { /* ... */ },
                        ),
                        FlatButton(
                          child: const Text('Humidity : 60%',style: TextStyle(color: Colors.green),),
                          onPressed: () { /* ... */ },
                        ),
                        FlatButton(
                          child: const Text('Soil Moisture: True',style: TextStyle(color: Colors.green),),
                          onPressed: () { /* ... */ },
                        ),
                      ],
                    ),
...
"https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQPBRX9xJGLhlbJ8Gz5_aJjr8E0CnWydjxZrQ&usqp=CAU"                      ),)
                  ...
                  ButtonTheme.bar( // make buttons use the appropriate styles for cards
                    child: ButtonBar(
                      children: <Widget>[
                        FlatButton(
                          child: const Text('Temperature : 23°C',style: TextStyle(color: Colors.green),),
                          onPressed: () { /* ... */ },
                        ),
                        FlatButton(
                          child: const Text('Humidity : 66%',style: TextStyle(color: Colors.green),),
                          onPressed: () { /* ... */ },
                        ),
                        FlatButton(
                          child: const Text('Soil Moisture: False',style: TextStyle(color: Colors.green),),
                          onPressed: () { /* ... */ },
                        ),
                      ],
                    ),
          ...
          children: <Widget>[
            ...
            ButtonTheme.bar( // make buttons use the appropriate styles for cards
              child: ButtonBar(
                children: <Widget>[
                  FlatButton(
                    child: const Text('8:30am - 9:40am',style: TextStyle(color: Colors.green),),
                    onPressed: () { /* ... */ },
                  ),
                  FlatButton(
                    child: const Text('6:30pm - 7:40pm',style: TextStyle(color: Colors.green),),
                    onPressed: () { /* ... */ },
                  ),
                  FlatButton(
                    child: const Text('          '),
